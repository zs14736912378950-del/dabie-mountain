...
export const moreSpecies = [
  ...
  // ===== 爬行类 =====
  {
    ...
    emoji: "🐍",
    description: "赤链蛇是大别山最常见的无毒蛇之一，身体上有红色的环状花纹。它们主要在夜间活动，捕食蛙类、蜥蜴和小型哺乳动物，是生态系统中重要的捕食者。",
    funFact: "赤链蛇虽然看起来可怕，但它是无毒的！红色花纹其实是一种'警告色'，让天敌不敢靠近。",
    protection: "常见物种"
  },
  {
