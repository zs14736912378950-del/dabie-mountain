...
export const species = [
  ...
  {
    id: "rhododendron", name: "大别山杜鹃", scientific: "Rhododendron dabanshanense",
  ...
  },
  {
    ...
    category: "植物", role: "生产者", trophic: 1,
    description: "霍山石斛是大别山最珍贵的药用植物之一，被誉为'中华仙草'。它只生长在霍山县境内海拔300-900米的阴湿岩石上，对生长环境要求极为苛刻，野生资源极其稀少。",
  ...
  },
  {
    ...
    funFact: "大鲵是真正的'活化石'——它们的祖先在3.5亿年前就已经出现了，比恐龙还要早1亿多年！",
    protection: "国家二级保护动物",
    emoji: "🐸"
  },
  {
  ...
  },
  {
    ...
    description: "金雕是大别山天空的霸主，翼展可达两米以上。它们锐利的眼睛能从高空锁定地面上的野兔和松鼠，然后以每小时300公里的速度俯冲捕猎。",
  ...
  },
  {
    ...
    description: "穿山甲全身覆盖着坚硬的角质鳞片，遇到危险时会蜷缩成一个'松果球'。它们是森林的'害虫克星'，一只穿山甲一年能吃掉7000万只白蚁，默默守护着森林的健康。",
  ...
  },
  {
    ...
    funFact: "中华虎凤蝶的幼虫只吃一种叫'细辛'的植物，如果这种植物消失了，蝴蝶也会跟着消失——这就是生态系统中'专一性'的奇妙与脆弱。",
    protection: "国家二级保护动物",
    emoji: "🦋"
  }
];
